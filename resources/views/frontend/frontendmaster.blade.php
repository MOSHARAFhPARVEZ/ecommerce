...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('frontend_assets') }}/assets/css/woocommerce-2.css">
                            ...
                            <ul class="header_select_options ul_li">
                                <li>
                                    <div class="select_option">
                                        <div class="flug_wrap">
                                            <img src="{{ asset('frontend_assets') }}/assets/images/flug/flug_uk.png"
                                                alt="image_not_found">
                                        </div>
                                        <select>
                        ...
                        <div class="col col-lg-3 col-md-3 col-sm-12">
                            <div class="brand_logo">
                                <a class="brand_link" href="{{ route('index') }}">
                                    <img src="{{ asset('frontend_assets') }}/assets/images/logo/logo_1x.png"
                                        srcset="{{ asset('frontend_assets') }}/assets/images/logo/logo_2x.png 2x" alt>
                                </a>
                            </div>
                        </div>
                                ...
                                <ul class="header_icons_group ul_li_right">
                                    ...
                                    <li>
                                        <span class="cart_icon">
                                            ...
                                            <small
                                                class="cart_counter">{{ App\Models\Cart::where('user_id', Auth::id())->count() }}</small>
                                        </span>
                                    </li>
                                </ul>
                            </button>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col col-md-3">
                            <ul class="header_icons_group ul_li_right">
                                ...
                                @guest
                                <li><a class="nav-link" href="{{ route('cusregi') }}">Login/Register</a></li>
                                @endguest
                ...
                <ul class="cart_items_list ul_li_block mb_30 clearfix">
                    ...
                    <li>
                        ...
                        <div class="item_content">
                            ...
                            <h4 class="item_title">Size *{{ $cart->rel_to_size->size }}</h4>
                            <h4 class="item_title">Color *{{ $cart->rel_to_color->color }}</h4>
                            <span class="item_price">
                                @if ($cart->rel_to_product->discount_price)
                                <span>৳{{ $cart->rel_to_product->discount_price }} X {{ $cart->quantity }} </span>
                                @else
                                <span>৳{{ $cart->rel_to_product->regular_price }} X {{ $cart->quantity }}</span>
                                @endif
                            </span>
                        </div>
                            ...
                            <div class="footer_widget footer_about">
                                <div class="brand_logo">
                                    <a class="brand_link" href="index.html">
                                        <img src="{{ asset('frontend_assets') }}/assets/images/logo/logo_1x.png"
                                            srcset="{{ asset('frontend_assets') }}/assets/images/logo/logo_2x.png 2x"
                                            alt="logo_not_found">
                                    </a>
                                </div>
                        ...
                        <div class="col col-lg-4 col-md-6 col-sm-6">
                            <div class="footer_widget footer_contact">
                                ...
                                <ul class="store_btns_group ul_li">
                                    <li><a href="#!"><img
                                                src="{{ asset('frontend_assets') }}/assets/images/app_store.png"
                                                alt="app_store"></a></li>
                                    <li><a href="#!"><img
                                                src="{{ asset('frontend_assets') }}/assets/images/play_store.png"
                                                alt="play_store"></a></li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col col-md-6">
                            <div class="payment_method">
                                <h4>Payment:</h4>
                                <img src="{{ asset('frontend_assets') }}/assets/images/payments_icon.png"
                                    alt="image_not_found">
                            </div>
                        </div>
                    </div>
