            ...
            <div class="basic-form">
                <form action="{{ route('policy.store') }}" method="POST">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" placeholder="Policy Tittle" name="policy_tittle">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-3 col-form-label">Policy Sub Tittle</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" placeholder="Policy Sub Tittle" name="policy_sub_tittle">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-3 col-form-label">Policy Icon</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" placeholder="Policy Icon" name="policy_icon">
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-sm-10">
