            ...
            <div class="deznav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                            ...
                            <span class="nav-text">About Part</span>
                        </a>
                        <ul aria-expanded="false">
                            {{-- banner part  --}}
                            <li><a href="{{ route('aboutpart.create') }}">Add Banner</a></li>
                            <li><a href="{{ route('aboutpart.index') }}">View Banner</a></li>
                            {{-- banner part  --}}
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                            <i class="flaticon-381-television"></i>
                            <span class="nav-text">Policy Part</span>
                        </a>
                        <ul aria-expanded="false">
                            <li><a href="{{ route('policy.create') }}">Add Policy</a></li>
                            <li><a href="{{ route('policy.index') }}">View Policy</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                            <i class="flaticon-381-television"></i>
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{ route('homebanner.create') }}">Add Home Banner</a></li>
                            <li><a href="{{ route('homebanner.index') }}">View Home Banner</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                            <i class="flaticon-381-television"></i>
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{ route('contactinfo.create') }}">Add Contact Info </a></li>
                            <li><a href="{{ route('contactinfo.index') }}">View Contact Info</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                            <i class="flaticon-381-television"></i>
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                            <i class="flaticon-381-television"></i>
                            <span class="nav-text">Varition</span>
                        </a>
                        <ul aria-expanded="false">

                            <li><a href="{{ route('varition.index') }}">Add Size</a></li>
                    ...
                    <li><a class="has-arrow ai-icon" href="{{ route('showorder') }}" aria-expanded="false">
                            <i class="flaticon-381-layer-1"></i>
                            <span class="nav-text">Show Order</span>
                        </a>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                            <i class="flaticon-381-television"></i>
